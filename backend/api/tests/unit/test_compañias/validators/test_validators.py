...
class TestValidators:
    ...
    def test_slug_muy_largo_lanza_error(self):
        with pytest.raises(ValueError, match="el slug no puede pasarse de 100 caract"):
    ...
    def test_parse_name_duplicated(self):
        ...
        assert "nombre" in message.lower()
    ...
    def test_parse_unknown_error(self):
        ...
        assert "conflicto de datos" in message.lower()
...
class TestValidateCompanyData:
    ...
    def test_slug_vacio_lanza_error(self):
        with pytest.raises(ValueError, match="slug vacio error"):
            _validate_company_data(
                {
                    "slug": ""
                }
    ...
    def test_name_muy_corto_lanza_error(self):
        with pytest.raises(ValueError, match="El nombre debe tener al menos 2 caracteres"):
            _validate_company_data(
                {
                    "name": "x"
                }
